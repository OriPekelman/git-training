...
**Disk.** N × working tree, as established. Fine for source. Painful the moment your repository holds large binaries — see [Git LFS](P4C4.md "Git LFS") for the shape of that problem.
...
**No amending or rebasing anything already pushed.** The rule from [Playing with our revisions](P1C7.md "Playing with our revisions") does not get suspended because a machine is typing. If a human or a CI job has seen the commit, it is history now.
