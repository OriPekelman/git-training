...
Cross-links: this is the same territory as [Worktrees](P4C1.md "Worktrees") and [Git for data and models](P4C5.md "Git for data and models"), from the other direction.
...
* **Gerrit** keeps its entire review dataset in the Git repository — NoteDb, with change metadata under `refs/changes/*/meta` and review data in notes refs — which is the same trick as [git notes](P4C3.md "git notes"), industrialised.
...
* **Argo CD** and **Flux** treat a Git repository as the desired state of a cluster and continuously reconcile reality against it — the whole subject of [GitOps](P5C1.md "GitOps").
