...
The line that matters is the last one. All the `hint:` lines above it are Git being chatty about the name of the very first branch it just created for us; we come back to that, and to what a branch even is, in [Playing with our revisions](P1C7.md "Playing with our revisions"). If you have already configured `init.defaultBranch`, you won't see the hint at all.
