...
> :information_source:
> So the recommendation is both, with a clear division of labour, and it is the same one this course makes about editors in [Editors, IDEs and the file browser](P3C4.md "Editors, IDEs and the file browser"):
>
...
* `lazygit` and `gitui` are the terminal answer to the same need — see [Making the command line yours](P3C1.md "Making the command line yours").
