...
In the [previous chapter](P5C3.md "Deploying a simple static site") we deployed a site by pushing
...
always green. That was the [previous chapter but one](P5C2.md "Continuous integration with Git").
...
[Playing with our revisions](P1C7.md "Playing with our revisions"); `%s` is the subject and `%h`
...
> [Keep a clean history, recover from mistakes](P2C6.md "Keep a clean history, recover from mistakes").
...
[A little structure please](P2C4.md "A little structure please") ends up being a discussion about
...
[GitOps](P5C1.md "GitOps"). We cannot make the production credential disappear in a push model —
...
> [Continuous integration](P5C2.md "Continuous integration with Git").

## And the other way round

Everything in this chapter is **push**: our CI reaches into production and changes it. Read it
next to [GitOps](P5C1.md "GitOps"), which is the same job done in reverse — a tag lands, an agent
